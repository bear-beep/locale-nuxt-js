...
var mainSearch = (function (window,document,$) {
    ...
    function doSearch(options, el,tr) {
        ...
        $.ajax({
            ...
            complete: function () {
                ...
                $(el).html('<span class="am-icon-search"></span> Find');
            },
    ...
    gEBI("filterSource").onkeydown = function (event) {
        ...
        if (e.keyCode === _keyCode._enter) {
            ...
            $.LoadTips('Find in progress, do not operate repeatedly');
    ...
    gEBI("filterBtn").onclick = function () {
        ...
        $(_this).html('Finding<i class="am-icon-spinner am-icon-spin"></i>');
        $.LoadTips('Find in progress, do not operate repeatedly');
        window.clearTimeout(searchTimer);
        searchTimer = window.setTimeout(function () {
            localParam.searchOringin = sourceVal;
    ...
    return new Promise(function (resolve, reject) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                $('#search_btn').html('<i class="am-icon-spinner am-icon-spin"></i>Searching');
            },
            complete: function () {
                $('#search_btn').removeAttr("disabled");
                $('#search_btn').html('<span class="am-icon-search"></span> Search');
                ...
                if (data.success) {
                    ...
                    result.forEach((item, index) => {
                        ...
                        html += `<tr class='tr-xm tm-tb-tr copy-tb' onclick="dealCatObj.showDetailTBTM(this)" data='{"name":"${item.modifier}","area":"${item.filename.replace(/'|"/g,'.')}","time":"${item.modifyTime}"}' data-db=${config.id ? config.id : ""}>
                                    ...
                                    <td class="trans-bg trans-tm">Project</td>
...
partSearch.prototype.copySearch = function (_proto_, ele) {
    ...
    tabSearch.click();
    $.LoadTips("Search in progress, do not operate repeatedly");
