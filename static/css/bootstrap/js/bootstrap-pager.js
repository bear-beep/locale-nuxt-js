/**
 * 分页组件,用于QA的分页情况
 * https://blog.csdn.net/jrn1012/article/details/76019353
 *
 */
(function ($, window, document, undefined) {
    ...
    BasePage.prototype.template = {
        ...
        li_pre_a: '<a href="javascript:void(0)" class="previous" style="" aria-controls="{0}" data-dt-idx="0" tabindex="0"> < </a>',
        ...
        li_next_a: '<a href="javascript:void(0)" class="next"  aria-controls="{0}" data-dt-idx="{1}" tabindex="{1}"> > </a>'
    }
